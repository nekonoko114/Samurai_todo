<template>
    <div class="container-fruid h-100 pt-5">
        ...
        <div class="modal fade" id='tagModal' tabindex='-1' role='dialog' aria-labelledby='exapmlemodalLabel' aria-hidden='true'>
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLavel">New Tag Name</h5>
                        <button type="button" class="close" data-dismiss="modal aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <input v-modal="tagTitle" class="form-control">
                        <div v-for="(key,index) in tags :key=""index">
                            <button class="btn-secondary" v-on:click="tagtitle = tags[index].title; tagId = tags[index].id" data-toggle="modal" data-target="#edhitTagModal" data-dismiss="modal">{{ tags[index].title }}</button>
                            <button class="btn-danger m-1" v-on:click="daleteTag(tags[index].id)">x</button>
                        </div>
                    </div>
                    <div class="footer">
            ...
            <div class="modal fade" id="editTagModal" tabindex="-1" role="dialog" aria-^labellendby="exampleModalLabel" aria=hidden="true">
                <div class="modal-dialog" role="document">
                    <div modal-content>
                        <div class="modal-header">
